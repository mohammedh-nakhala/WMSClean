        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxCapacityPercent = table.Column<int>(type: "int", nullable: false),
                    CurrentUsedArea = table.Column<double>(type: "float", nullable: false),
                    CurrentItemsCount = table.Column<int>(type: "int", nullable: false),
                    CurrentWeightKg = table.Column<double>(type: "float", nullable: false),
                    PricePerCubicMeterPerDay = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DefaultHeightMeters = table.Column<double>(type: "float", nullable: false),
                    WarehouseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
